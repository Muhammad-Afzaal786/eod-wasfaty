            ...
            <Row className="mt-1">
              ...
              <Col lg="12 mb-2">
                ...
                <input
                  type="number"
                  class="form-control"
                  name="comercial_registration"
                  id="comercial_registration_val"
                />
              </Col>
              <Col lg="12 mb-2">
                <form>
              ...
              <Col lg="12 mb-2">
                ...
                <select class="form-select" aria-label="Default select example">
                  <option selected></option>
                  <option value="1">
                    practicing the activity before obtaining the licensing
                  </option>
                  <option value="2">
                    did not comply with the license renewal request within 30
                    days before the expiry of the license
                  </option>
                  <option value="3">
                    closure of the facility temporary closure of the entire
                    facility or part of it without notifying the ministry
                  </option>
                  <option value="4">
                    closure of the facility permanent closure of entire facility
                    and cancellation of the license without notifying the
                    ministry
                  </option>
                  <option value="5">
                    failure to update data of all the tourist accommodation
                    facilities in electronic system for licensing tourist
                    accommodation as soon as it changes
                  </option>
              ...
              <Col lg="12 mb-2">
                <form>
                  <span>
                    Record Picture <strong style={{ color: "red" }}> * </strong>
                  </span>
                  <input type="file" id="myFile" name="filename" />
                </form>
              </Col>
              ...
              <Col lg="12 mb-2">
                ...
                <select class="form-select" aria-label="Default select example">
                  ...
                  <option value="2">
                    The Facility is closed Permanent closure
                  </option>
                  <option value="3">
                  ...
                  <option value="5">
                    {" "}
                    There is no way point for the facility and it is not
                    possibles
                  </option>
                </select>
              </Col>
